			...
			<div class="main-bar clearfix">
				<div class="container clearfix">
					...
					<div class="logo-header logo-dark">
						<a href="index.php"><img src="../adminside/images/logo.png" alt="logo"></a>
					</div>
						...
						<li><a href="home.php"><span>Home</span></a></li>
							...
							<li class="sub-menu-down"><a href="javascript:void(0);"><span>Pages</span></a>
								<ul class="sub-menu">
									...
									<li><a href="product.php">Shop List</a></li>
								
									
							</li>
							<li><a href="blog1.php"><span>blog</span></a></li>
							<li><a href="contact-us.php"><span>Contact Us</span></a></li>
							<li><a href="shop-login.php"><span>login</span></a></li>
